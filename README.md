...
|----------|--------|--------|
| Approche data scientiste | 10 | ✅ |
| Dataset étudié et expliqué | 5 | ✅ |
| Caractéristiques des données | 5 | ✅ |
| Manipulation de données | 10 | ✅ |
| Librairies Python expliquées | 5 | ✅ |
| 3+ Visualisations graphiques | 10 | ✅ |
| 2 Modèles ML (RF + KNN) | 20 | ✅ |
| Comparaison détaillée | 20 | ✅ |
| Code commenté + explications | 15 | ✅ |
| **TOTAL** | **100** | **✅** |
